...
namespace IntegralInvesting.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<IntegralInvestingUser> _userStore;
        ...
        public RegisterModel(
            ...
            IUserStore<IntegralInvestingUser> userStore,
        ...
        {
            // If user is logged in, redirect them back to Home page
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Additional properties that were added to user
        ...
        private IntegralInvestingUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<IntegralInvestingUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(IntegralInvestingUser)}'. " +
                    $"Ensure that '{nameof(IntegralInvestingUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<IntegralInvestingUser> GetEmailStore()
        {
